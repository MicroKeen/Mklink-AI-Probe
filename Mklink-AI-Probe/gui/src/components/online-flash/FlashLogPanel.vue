...
<style scoped>
header{display:flex;justify-content:space-between;align-items:center;padding:7px 10px;border-bottom:1px solid var(--of-border)}h3{margin:0;font-size:12px}h3 span{color:var(--of-muted);font-weight:400}button{margin-left:5px;padding:4px 7px;border:1px solid var(--of-border);border-radius:4px;background:var(--of-input);color:var(--of-text);font-size:10px}.log-window{height:135px;overflow:auto;padding:0 10px;text-align:left;background:var(--of-bg);color:var(--of-text);font:10px/18px var(--of-mono)}.log-line{height:18px;line-height:18px;box-sizing:border-box;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.log-window p{color:var(--of-muted)}
</style>
