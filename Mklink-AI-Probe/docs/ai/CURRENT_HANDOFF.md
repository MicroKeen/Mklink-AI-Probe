...
- 更新时间：`2026-09-10T10:14:15+08:00`
...
- 当前任务：MicroKeen 的 updates 已重命名为 release，保护规则与维护文档同步调整；PR #1 待审核，正式发布服务未迁移。
- 状态：`ready`
...
3. 正式发布仍使用原 Aladdin-Wang/Gitee 渠道。新 release/firmware 不自动同步；切换前另行适配发布脚本并验证资产、签名与旧客户端兼容。
