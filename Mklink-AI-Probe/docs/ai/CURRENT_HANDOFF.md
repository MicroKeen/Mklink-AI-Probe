...
- 更新时间：`2026-09-20T20:06:15.2058251+08:00`
...
- 当前任务：HPM5301脱机OTP和断电保持验收完成；用户授权启用Windows开发模式后12项符号链接测试补跑全部通过，继续标准NSIS候选构建，尚未发布。
- 状态：`in_progress`
...
1. HPM5301脱机OTP验收与软件全量回归通过；继续标准NSIS构建和覆盖安装资格，不直接发布渠道。Windows开发人员模式按用户授权已开启。
